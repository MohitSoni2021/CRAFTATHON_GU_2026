                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center space-x-3 px-4 py-2.5 rounded-sm transition-all duration-300 group ${isActive
                                    ? 'bg-gradient-primary text-white shadow-md shadow-[#7A8E6B]/20'
                                    : 'text-gray-500 hover:bg-[#7A8E6B]/10 hover:text-[#7A8E6B]'
                                    }`}
                            >
                                <item.icon className={`text-lg ${isActive ? 'text-white' : 'text-gray-400 group-hover:text-[#7A8E6B]'}`} />
