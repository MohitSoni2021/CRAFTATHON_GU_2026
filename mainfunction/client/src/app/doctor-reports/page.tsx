        ...
        <ProtectedRoute>
            <DashboardLayout>
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        <h1 className="text-xl font-bold text-gray-800">Doctor Visits</h1>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-16 bg-white rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">No doctor visits recorded</h3>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <Link href={`/doctor-reports/${report._id}`} className="hover:underline">
                                                <h3 className="text-base font-bold text-gray-800">{report.doctorName || 'Doctor Visit'}</h3>
                                            </Link>
