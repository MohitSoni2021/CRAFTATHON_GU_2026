        ...
        <ProtectedRoute>
            <DashboardLayout>
                ...
                <header className="mb-10 text-center">
                    <h1 className="text-xl font-extrabold text-gray-800 mb-2">Prescription Scanner</h1>
                    <p className="text-gray-500 text-base">Upload or take a photo of your doctor's prescription.</p>
                </header>
                            ...
                            <div className="space-y-6">
                                {result.isLimitError ? (
                                    <div className="p-6 bg-yellow-50 border border-yellow-200 rounded-2xl text-center">
                                        <h3 className="text-lg font-bold text-yellow-800 mb-2">Daily Limit Reached</h3>
                                    ...
                                    <>
                                        <div className="bg-blue-50 p-6 rounded-2xl relative">
                                            ...
                                            <p className="text-blue-900 text-base leading-relaxed">{result.audioSummary}</p>
                                        </div>
