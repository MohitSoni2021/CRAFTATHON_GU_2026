        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold tracking-tight text-[#2C2C2C]">
              Swasthya<span className="text-gradient">Saathi</span>
            </span>
          </div>
          <div className="flex items-center gap-4">
            <Link
              href="/login"
              className="hidden sm:block px-6 py-2.5 rounded-full font-semibold text-[#5A6C4D] hover:bg-[#7A8E6B]/10 transition-colors"
            >
              Login
            </Link>
            <Link
              href="/signup"
              className="btn-primary !py-2.5 !px-6 !text-base shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
              Get Started
            </Link>
          </div>
        ...
        <section className="relative pt-20 pb-32 overflow-hidden px-6">
          ...
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              SwasthyaSaathi empowers you to take control of your well-being.
              Securely store medical records, track vital trends, and maintain a
              personal health diary — all in one beautiful, accessible place.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <Link
                href="#features"
                className="px-8 py-4 rounded-full font-semibold text-[#5A6C4D] border border-[#A9C29B]/30 hover:bg-[#E8F3E3] transition-all w-full sm:w-auto min-w-[200px] text-center"
              >
                Explore Features
              </Link>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                We've built a comprehensive suite of tools to help you stay on
                top of your health, organize your medical history, and gain
                valuable insights.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="glass p-8 rounded-3xl card-hover space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                  More than just a journal. Log symptoms, medications, and daily
                  feelings. Detect patterns in your health over time with our
                  intuitive interface.
                </p>
              </div>
              ...
              <div className="glass p-8 rounded-3xl card-hover space-y-4 border-[#7A8E6B]/30 shadow-md transform md:-translate-y-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Never lose a prescription or lab report again. Upload,
                  categorize, and search your medical documents instantly.
              ...
              <div className="glass p-8 rounded-3xl card-hover space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Keep a close eye on your blood pressure, sugar levels, BMI,
                  and more. Visual charts help you and your doctor understand
                  your progress.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-[#2C2C2C] mb-2">
                        Gain Actionable Insights
                      </h4>
                      <p className="text-gray-600">
                        Visualize your health data to understand what works for
                        your body and what doesn't. Make informed decisions
                        every day.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Your health data is sensitive. We treat it that way with
                        bank-grade encryption and strict privacy controls. You
                        own your data.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Whether you're at the doctor's office or on vacation,
                        your complete medical history is right in your pocket.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass p-8 rounded-3xl relative z-10 border-[#FFFFFF]/50 shadow-2xl">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                      ...
                      <div className="px-3 py-1 rounded-full bg-[#E8F3E3] text-[#5A6C4D] text-sm font-medium">
                        Updated 2m ago
                      </div>
                    </div>
                    ...
                    <div className="pt-4">
                      <Link
                        href="/signup"
                        className="block w-full text-center py-3 rounded-xl bg-gray-50 hover:bg-gray-100 font-semibold text-[#5A6C4D] transition-colors"
                      >
                        View Full Report
                      </Link>
                    </div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-5xl mx-auto glass p-12 rounded-[2.5rem] text-center relative overflow-hidden">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
              ...
              mind that comes with organized health management.
            </p>
            <Link
              href="/signup"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                <li>
                  <Link
                    href="#"
                    className="hover:text-[#7A8E6B] transition-colors"
                  >
                    Health Diary
                  </Link>
                </li>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Start your journey to better health documentation today.
              </p>
              <Link
                href="/signup"
                className="text-[#7A8E6B] font-bold hover:underline"
              >
                Sign Up Now &rarr;
              </Link>
            </div>
