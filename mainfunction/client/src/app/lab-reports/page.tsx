        ...
        <ProtectedRoute>
            <DashboardLayout>
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        <h1 className="text-xl font-bold text-gray-800">Lab Reports</h1>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-16 bg-white rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">No lab reports found</h3>
                        ...
                        {reports.map((report) => (
                            <Link href={`/lab-reports/${report._id}`} key={report._id} className="block h-full">
                                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-[#7A8E6B]/30 hover:shadow-md transition flex flex-col h-full cursor-pointer">
                                    ...
                                    <h3 className="text-base font-bold text-gray-800 mb-1">{report.testType}</h3>
