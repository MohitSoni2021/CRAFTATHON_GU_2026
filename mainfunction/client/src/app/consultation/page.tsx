...
import { FaMicrophone, FaStop, FaRobot, FaVolumeUp, FaLanguage, FaFileUpload, FaChevronRight, FaHeartbeat, FaWaveSquare, FaPlus } from 'react-icons/fa';
            ...
            <DashboardLayout>
                ...
                <div className="w-full flex flex-col min-h-[85vh]">
                    ...
                    <header className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight text-gray-900">AI Consultation</h1>
                            <p className="text-gray-500 mt-2 font-medium">Describe your symptoms via voice for an immediate health assessment.</p>
                        </div>
                        <Link
                        ...
                        <div className="w-full max-w-4xl z-10 flex flex-col items-center">
                            ...
                            <div className="text-center mb-16">
                                <h2 className="text-5xl font-extrabold text-gray-900 mb-6 tracking-tight leading-tight">
                                    How are you <span className="bg-gradient-primary bg-clip-text text-transparent">feeling?</span>
                                </h2>
                            ...
                            <div className="relative mb-20 group">
                                ...
                                <button
                                    ...
                                    className={`relative z-20 w-32 h-32 rounded-xl flex items-center justify-center text-4xl shadow-2xl transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98] ${listening
                                ...
                                <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 w-64 text-center">
                                    <p className={`font-extrabold uppercase tracking-[0.3em] text-[10px] transition-colors duration-300 ${listening ? 'text-rose-500 animate-pulse' : 'text-gray-400'}`}>
                            ...
                            <div className="flex items-center space-x-4 mb-16 p-1.5 bg-surface-container-low rounded-xl border border-outline-variant shadow-sm">
                                {['en', 'hi', 'gu'].map((lang) => (
                                    <button
                                        ...
                                        className={`px-8 py-3 rounded-lg font-bold text-xs uppercase tracking-widest transition-all duration-300 ${language === lang
                                    ...
                                    <div className="flex flex-col gap-10">
                                        ...
                                        <div className="border-b border-outline-variant pb-8">
                                            <div className="flex items-center justify-between mb-6">
                                                <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] flex items-center">
                                                    <span className="w-1.5 h-1.5 rounded-full bg-primary/40 mr-2"></span> Recorded Transcript
                                                </h3>
                                                <span className="text-[10px] font-bold text-primary px-2 py-0.5 bg-primary/5 rounded border border-primary/10">Audio-to-Text</span>
                                            </div>
                                        ...
                                        <div className="relative min-h-[100px]">
                                            <div className="flex justify-between items-center mb-8">
                                                ...
                                                {aiResult?.urgency && (
                                                    <div className={`px-4 py-1.5 rounded-xl text-[10px] font-bold uppercase tracking-widest shadow-sm ${aiResult.urgency === 'High' ? 'bg-rose-500 text-white' :
                                                        aiResult.urgency === 'Medium' ? 'bg-amber-500 text-white' : 'bg-primary text-white'
                                                        }`}>
                                            ...
                                            {analyzing ? (
                                                <div className="flex flex-col items-center justify-center py-10 gap-4">
                                                    ...
                                                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Processing Bio-Signals...</p>
                                                </div>
                                            ) : (
                                                    ...
                                                    <div className="p-8 bg-surface-container-low rounded-xl border border-outline-variant relative overflow-hidden group">
                                                        ...
                                                        {aiResult?.isLimitError && (
                                                            <div className="mt-8 p-6 bg-white border border-amber-200 rounded-xl shadow-sm">
                                                                <h4 className="font-extrabold text-gray-900 text-sm mb-2 uppercase tracking-wide">Usage Limit Reached</h4>
                                                        ...
                                                        {aiResult?.summary && !aiResult?.isLimitError && (
                                                            <div className="mt-8 flex items-center space-x-4 relative z-10">
                                                                ...
                                                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Synthetic Audio Ready</span>
                                                            </div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                        ...
                                                        {aiResult?.lifestyleAdvice && aiResult.lifestyleAdvice.length > 0 && (
                                                            <div className="p-6 bg-primary/[0.03] rounded-xl border border-primary/10">
                                                                <h4 className="font-extrabold text-primary text-[10px] uppercase tracking-[0.2em] mb-4">🌱 Lifestyle Protocol</h4>
                                                        ...
                                                        {aiResult?.suggestedMedicines && aiResult.suggestedMedicines.length > 0 && (
                                                            <div className="p-6 bg-tertiary/[0.03] rounded-xl border border-tertiary/10">
                                                                <h4 className="font-extrabold text-tertiary text-[10px] uppercase tracking-[0.2em] mb-4">💊 Care Recommendations</h4>
                                                        ...
                                                        <div className="pt-8 border-t border-outline-variant">
                                                            {aiResult.reviewStatus === 'reviewed' ? (
                                                                <div className="bg-tertiary/[0.05] p-6 rounded-xl border border-tertiary/20 flex items-start gap-4">
                                                                    ...
                                                                    <div>
                                                                        <h4 className="font-extrabold text-gray-900 text-sm mb-1 uppercase tracking-tight">Physician Verified Assessment</h4>
                                                                ...
                                                                <div className="flex items-center justify-between p-6 bg-surface-container-low rounded-xl border border-outline-variant">
                                                                    <div className="flex items-center gap-3">
                                                                        ...
                                                                        <span className="font-bold text-gray-900 text-xs uppercase tracking-widest">Verification Pending</span>
                                                                    </div>
                                                                    <span className="text-[10px] font-medium text-gray-400">Review requested successfully</span>
                                                                </div>
                                                            ) : (
