        ...
        <ProtectedRoute>
            <DashboardLayout>
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        <h1 className="text-xl font-bold text-gray-800">Health Diary</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <h3 className="text-xl font-bold text-gray-800">{entries.length}</h3>
                        </div>
                    </div>
                        ...
                        {entries.map((entry) => (
                            <div key={entry._id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-[#7A8E6B]/30 hover:shadow-md transition flex flex-col h-full group relative">
                                ...
                                <Link href={`/diary/${entry._id}`} className="block flex-grow">
                                    <h3 className="text-base font-bold text-gray-800 mb-2 line-clamp-1 hover:text-blue-600 transition">{entry.summary}</h3>
