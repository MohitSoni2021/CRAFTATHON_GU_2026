                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center space-x-3 px-5 py-3.5 rounded-sm transition-all duration-300 group ${isActive
                                    ? 'bg-gradient-primary text-white shadow-md shadow-[#3bbdbf]/20'
                                    : 'text-gray-500 hover:bg-[#3bbdbf]/10 hover:text-[#3bbdbf]'
                                    }`}
                            >
                                <item.icon className={`text-xl ${isActive ? 'text-white' : 'text-gray-400 group-hover:text-[#3bbdbf]'}`} />
                                <span>{item.name}</span>
                            </Link>
                        );
                    })}
