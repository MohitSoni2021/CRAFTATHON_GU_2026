                ...
                <div className="p-8">
                    <Link href="/dashboard" className="flex items-center gap-2">
                        ...
                        <div className="flex items-baseline">
                            <span className="text-2xl font-bold text-gray-900 tracking-tight">Life</span>
                            <span className="text-2xl font-bold text-[#3bbdbf] tracking-tight">Doc</span>
                        </div>
                    </Link>
                </div>
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center space-x-3 px-5 py-3.5 rounded-xl transition-all duration-300 group ${isActive
                                    ? 'bg-gradient-to-r from-[#2b7a8c] to-[#3bbdbf] text-white shadow-md shadow-[#3bbdbf]/30'
                                    : 'text-gray-500 hover:bg-[#3bbdbf]/10 hover:text-[#2b7a8c]'
                                    }`}
                            >
                                <item.icon className={`text-xl ${isActive ? 'text-white' : 'text-gray-400 group-hover:text-[#2b7a8c]'}`} />
                                <span>{item.name}</span>
                            </Link>
                        );
                    })}
