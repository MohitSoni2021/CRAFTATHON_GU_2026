...
function VoiceAssistantComponent({ className }: VoiceAssistantProps) {
    ...
    return (
        <>
            ...
            ${listening ? 'bg-red-500 animate-pulse' : 'bg-[#3bbdbf]'} text-white ${className || ''}`}
                        ...
                        <div className="p-6 text-center">
                            {view === 'listening' ? (
                                ...
                                <div className="text-left space-y-4">
                                    <div className="p-4 bg-[#3bbdbf]/10 rounded-lg border border-[#3bbdbf]/20">
                                        <h4 className="font-bold text-[#2b7a8c] mb-2">Detected Measurement</h4>
                                        <div className="grid grid-cols-2 gap-2 text-sm">
                                            <span className="text-gray-600">Type:</span>
                                            <span className="font-medium">Glucose (Sugar)</span>

                                            <span className="text-gray-600">Value:</span>
                                            <span className="font-bold text-lg text-[#3bbdbf]">{parsedData?.value} mg/dL</span>
                            ...
                            {view === 'listening' ? (
                                !listening && (
                                    <button
                                        ...
                                        className="px-4 py-2 bg-[#3bbdbf] text-white rounded-lg hover:bg-[#2b7a8c] transition-colors text-sm font-bold shadow-md shadow-[#3bbdbf]/20"
                                    >
                                        Resume Listening
                                    </button>
                                )
                                ...
                                <>
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-6 py-2 bg-[#3bbdbf] text-white rounded-lg hover:bg-[#2b7a8c] transition-colors text-sm font-bold shadow-md shadow-[#3bbdbf]/20"
                                    >
