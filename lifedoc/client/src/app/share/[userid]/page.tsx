        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="flex flex-col items-center gap-4">
                    <div className="w-12 h-12 border-4 border-[#3bbdbf]/30 border-t-[#3bbdbf] rounded-full animate-spin"></div>
        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="bg-white rounded-3xl shadow-sm overflow-hidden border border-gray-100">
                    <div className="bg-[#3bbdbf] h-32 relative">
                        <div className="absolute -bottom-16 left-8">
                            <div className="w-32 h-32 bg-white rounded-full p-1.5 shadow-lg">
                                <div className="w-full h-full rounded-full bg-gray-100 overflow-hidden flex items-center justify-center text-4xl font-bold text-[#3bbdbf]">
                                    {user?.profileImage ? (
                ...
                {user?.profile?.storyDesc && (
                    <div className="bg-white rounded-3xl shadow-sm p-8 border border-gray-100">
                        ...
                        <div className="bg-[#3bbdbf]/5 p-6 rounded-2xl border border-[#3bbdbf]/10">
                                ...
                                {Object.keys(measurements.reduce((acc: any, m: any) => {
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-xl font-semibold whitespace-nowrap capitalize transition-all flex items-center gap-2 ${activeTab === type
                                            ? 'bg-[#3bbdbf] text-white shadow-md shadow-[#3bbdbf]/20'
