        ...
        <ProtectedRoute>
            <DashboardLayout>
                <header className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 animate-fade-in-up">
                    ...
                    <div>
                        ...
                        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900">
                            {getGreeting()}, <span className="text-[#3bbdbf]">{user?.name || 'User'}</span> 👋
                        </h1>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
                    <div id="onboarding-ai-assistant" className="lg:col-span-2 relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#2b7a8c] to-[#3bbdbf] shadow-lg group">
                        ...
                        <div className="relative z-10 p-8 flex flex-col items-start h-full justify-between">
                            <div>
                                <div className="flex items-center space-x-2 text-[#eaf4f6] text-sm font-bold mb-4 tracking-wide uppercase">
                                    <FaRobot className="animate-bounce" /> <span>AI Health Assistant</span>
                                </div>
                                <h2 className="text-3xl font-bold text-white mb-2 leading-tight">
                                    Feeling unwell? <br /> Let AI analyze your symptoms.
                                </h2>
                                <p className="text-[#eaf4f6]/80 text-base max-w-lg mt-2">
                                    Get instant medical insights and analysis by describing your condition or uploading a report.
                                </p>
                            </div>
                            <Link href="/consultation" className="mt-8 bg-white text-[#2b7a8c] px-8 py-3 rounded-xl font-bold text-sm shadow-xl hover:bg-gray-50 hover:scale-105 transition-all flex items-center space-x-2">
                                <FaMicrophone /> <span>Start Voice Session</span>
                            </Link>
                        </div>
                    </div>

                    <Link id="onboarding-lab-reports" href="/lab-reports" className="group relative overflow-hidden rounded-2xl bg-white border border-gray-100 p-8 flex flex-col justify-between hover:border-[#3bbdbf]/50 hover:shadow-lg transition-all duration-300">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#3bbdbf] opacity-5 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-transform duration-500"></div>

                        <div className="flex items-start justify-between mb-6 relative z-10">
                            <div className="p-4 bg-cyan-50 text-[#3bbdbf] rounded-2xl group-hover:rotate-12 transition-transform duration-300">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-[#3bbdbf] font-bold text-sm flex items-center group-hover:translate-x-1 transition-transform">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Link href="/measurements" className="text-[#3bbdbf] font-bold hover:underline text-sm">View All</Link>
                            </div>
                                    ...
                                    {measurements.slice(0, 3).map((m, i) => (
                                        <div key={i} className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-100 group">
                                            <div className="flex items-center">
                                                <div className="w-12 h-12 bg-[#eaf4f6] text-[#2b7a8c] rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                                                    <FaCalendarCheck />
                                                </div>
                                                <div>
