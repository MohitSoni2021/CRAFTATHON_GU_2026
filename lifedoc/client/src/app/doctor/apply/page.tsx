...
export default function DoctorApplicationPage() {
    ...
    const checkStatus = async () => {
        try {
            const res = await axios.get("http://localhost:5002/api/doctor-verification/status", {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await axios.post("http://localhost:5002/api/doctor-verification/apply", formData, {
                headers: {
