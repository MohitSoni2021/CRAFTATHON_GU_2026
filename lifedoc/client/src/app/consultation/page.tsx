        ...
        <ProtectedRoute>
            <DashboardLayout>
                ...
                <div className="flex flex-col items-center justify-center min-h-[85vh] relative overflow-hidden w-full">
                    ...
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#3bbdbf]/5 rounded-full blur-3xl pointer-events-none -mr-32 -mt-32"></div>
                    <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#2b7a8c]/5 rounded-full blur-3xl pointer-events-none -ml-32 -mb-32"></div>

                    <div className="w-full max-w-4xl z-10 flex flex-col items-center">

                        {/* Header */}
                        <div className="text-center mb-12">
                            <div className="inline-flex items-center space-x-2 bg-white/50 backdrop-blur-md px-4 py-1.5 rounded-full text-[#3bbdbf] text-sm font-bold mb-4 border border-[#3bbdbf]/20 shadow-sm">
                            ...
                            {['en', 'hi', 'gu'].map((lang) => (
                                <button
                                    ...
                                    className={`px-6 py-2.5 rounded-full font-bold text-sm transition-all duration-300 ${language === lang
                                        ? 'bg-gradient-primary text-white shadow-lg shadow-[#3bbdbf]/25'
                                        : 'text-gray-500 hover:text-[#3bbdbf] hover:bg-white/60'
                                        }`}
                                >
                        ...
                        <div className="relative mb-12 group">
                            ...
                            {listening && (
                                <>
                                    <div className="absolute inset-0 bg-[#3bbdbf] rounded-full animate-ping opacity-20 scale-150"></div>
                                    <div className="absolute inset-0 bg-[#2b7a8c] rounded-full animate-ping opacity-10 scale-125 animation-delay-200"></div>
                                </>
                            )}
                                ...
                                <div className="flex flex-col gap-8">
                                    ...
                                    <div className="relative">
                                        <div className="flex justify-between items-center mb-4">
                                            <h3 className="text-xs font-bold text-[#3bbdbf] uppercase flex items-center">
                                                <span className="w-2 h-2 rounded-full bg-[#3bbdbf] mr-2"></span> LifeDoc Analysis
                                            </h3>
                                            {aiResult?.urgency && (
                                        ...
                                        {analyzing ? (
                                            <div className="flex space-x-2 py-4 justify-center">
                                                <div className="w-2.5 h-2.5 bg-[#3bbdbf] rounded-full animate-bounce"></div>
                                                <div className="w-2.5 h-2.5 bg-[#2b7a8c] rounded-full animate-bounce animation-delay-100"></div>
                                                <div className="w-2.5 h-2.5 bg-[#3bbdbf] rounded-full animate-bounce animation-delay-200"></div>
                                            </div>
                                        ) : (
                                                ...
                                                <div>
                                                    ...
                                                    {aiResult?.summary && !aiResult?.isLimitError && (
                                                        <button
                                                            ...
                                                            className="mt-2 text-sm font-bold text-[#3bbdbf] hover:text-[#2b7a8c] transition-colors flex items-center"
                                                        >
