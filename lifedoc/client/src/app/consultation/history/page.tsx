                ...
                <div className="w-full max-w-[1920px] mx-auto min-h-screen">
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-extrabold text-gray-900 flex items-center gap-3">
                            <FaHistory className="text-[#3bbdbf]" /> My Health History
                        </h1>
                            ...
                            <div className="overflow-y-auto flex-1 p-2 space-y-2">
                                {loading ? (
                                    ...
                                    <div className="p-8 text-center text-gray-400">
                                        ...
                                        <a href="/consultation" className="text-[#3bbdbf] font-bold mt-2 block hover:underline">Start a new one</a>
                                    </div>
                                ) : (
                                    consultations.map((item) => (
                                        <div
                                            ...
                                            className={`p-4 rounded-xl cursor-pointer transition-all border ${selectedConsultation?._id === item._id
                                                ? 'bg-[#3bbdbf]/10 border-[#3bbdbf] shadow-md'
                                                : 'bg-white border-gray-100 hover:border-[#3bbdbf]/50 hover:bg-gray-50'
                                                }`}
                                        >
