            ...
            <DashboardLayout>
                <div className="flex flex-col min-h-screen bg-gray-50/30">
                    ...
                    <div className="w-full px-4 sm:px-6 lg:px-8 max-w-[1920px] mx-auto">
                        {/* Profile Header Card */}
                        <div className="bg-gradient-to-r from-[#3bbdbf] to-[#2b7a8c] rounded-3xl p-8 mb-8 shadow-xl relative overflow-hidden ring-1 ring-black/5">
                            <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
                                <div className="relative group perspective-1000">
                                    <div className="w-28 h-28 bg-white rounded-2xl rotate-3 shadow-lg flex items-center justify-center text-5xl font-bold text-[#3bbdbf] border-4 border-white overflow-hidden transform transition-transform group-hover:rotate-0 duration-300">
                                        {user?.profileImage ? (
                                    ...
                                    <button
                                        ...
                                        className="absolute bottom-0 right-0 bg-white p-2 rounded-full shadow-md text-gray-600 hover:text-[#3bbdbf] transition-colors"
                                    >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow h-full">
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                                        <FaIdCard className="text-[#3bbdbf]" />
                                        Personal Information
                                    </h3>
                                    <button
                                        onClick={() => setEditSection('personal')}
                                        className="text-gray-400 hover:text-[#3bbdbf] transition-colors"
                                    >
                                        <FaEdit />
                                    </button>
                                </div>
                            ...
                            <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                                        <FaUser className="text-[#3bbdbf]" />
                                        Health Profile
                                    </h3>
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => setShowExplainModal(true)}
                                            className="text-[#3bbdbf] hover:text-[#2b7a8c] transition-colors flex items-center gap-1 text-sm font-semibold bg-[#3bbdbf]/10 px-3 py-1.5 rounded-lg"
                                        >
                                            <FaStethoscope />
                                            Explain Yourself
                                        </button>
                        ...
                        <div className="mt-8 bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button
                                    ...
                                    className="text-sm font-semibold text-[#3bbdbf] hover:text-[#2b7a8c] transition-colors flex items-center gap-1 bg-[#3bbdbf]/10 px-3 py-1.5 rounded-lg"
                                >
                                    + Add Contact
                                </button>
                            </div>
                        ...
                        {user?.profile?.storyDesc && (
                            <div className="mt-8 bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex items-center gap-2 mb-4">
                                    <div className="w-10 h-10 bg-[#3bbdbf]/10 rounded-full flex items-center justify-center text-[#3bbdbf]">
                                        <FaStethoscope />
                                    </div>
                                    <h3 className="text-lg font-bold text-gray-800">My Health Story</h3>
                                </div>
                                <div className="p-6 bg-[#3bbdbf]/5 rounded-xl border border-[#3bbdbf]/20">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="bg-[#3bbdbf] text-white px-4 py-2 rounded-lg font-semibold hover:bg-[#2b7a8c] transition-colors flex items-center gap-2 whitespace-nowrap"
                                            >
                                                {copySuccess ? <FaCheck /> : <FaShareAlt />}
                                    ...
                                    <div className="pt-4 border-t border-gray-100 flex flex-col items-center">
                                        {!showQR ? (
                                            <button
                                                ...
                                                className="text-[#3bbdbf] font-bold hover:underline flex items-center gap-2"
                                            >
                                                Generate QR Code
                                            </button>
                                        ) : (
                        ...
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl transform transition-all scale-100">
                                    ...
                                    {editSection === 'personal' && (
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#3bbdbf]/50"
                                            />
                                        </div>
                                    )}
                                ...
                                <div className="p-6 border-t border-gray-100 flex justify-end gap-3 rounded-b-2xl bg-gray-50">
                                    ...
                                    <button
                                        onClick={handleSave}
                                        className="px-5 py-2.5 rounded-xl font-semibold bg-[#3bbdbf] text-white hover:bg-[#2b7a8c] shadow-md shadow-[#3bbdbf]/20 transition-all"
                                    >
                                        Save Changes
                                    </button>
                                </div>
                    ...
                    {showExplainModal && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                            <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
                                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-[#3bbdbf] text-white">
                                ...
                                <div className="p-8 overflow-y-auto flex-1">
                                        ...
                                        <div className="space-y-6">
                                                ...
                                                {commonDiseases.map(disease => (
                                                    <button
                                                        ...
                                                        className={`p-4 rounded-xl border-2 transition-all flex items-center justify-center text-center font-medium ${selectedDiseases.includes(disease)
                                                            ? 'border-[#3bbdbf] bg-[#3bbdbf]/10 text-[#3bbdbf]'
                                                            : 'border-gray-100 hover:border-[#3bbdbf]/50 text-gray-600'
                                                            }`}
                                                    >
                                                        {disease}
                                            ...
                                            <div className="flex justify-end pt-4">
                                                <button
                                                    ...
                                                    className="bg-[#3bbdbf] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#2b7a8c] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-all"
                                                >
                                        ...
                                        <div className="space-y-8">
                                                    ...
                                                    <div key={index} className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                                        ...
                                                        {q.type === 'mcq' && q.options ? (
                                                                ...
                                                                {q.options.map((option: string, optIdx: number) => (
                                                                    <button
                                                                        ...
                                                                        className={`w-full p-4 text-left rounded-xl border-2 transition-all ${q.ans === option
                                                                            ? 'border-[#3bbdbf] bg-[#3bbdbf]/10 text-[#3bbdbf] font-semibold'
                                                                            : 'border-gray-100 hover:border-[#3bbdbf]/50 text-gray-600'
                                                                            }`}
                                                                    >
                                                                        {option}
                                                            ...
                                                            <textarea
                                                                ...
                                                                className="w-full h-32 p-4 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3bbdbf]/50 resize-none"
                                                            ></textarea>
                                                        )}
                                                    </div>
                                                ))}
                                            ...
                                            <div className="flex justify-end pt-4">
                                                <button
                                                    ...
                                                    className="bg-[#3bbdbf] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#2b7a8c] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-all shadow-lg shadow-[#3bbdbf]/20"
                                                >
                                                    Submit Analysis
                                                    <FaChevronRight />
                                                </button>
                                    ...
                                    {explainStep === 3 && (
                                        <div className="text-center space-y-6 py-8">
                                            <div className="w-20 h-20 bg-[#3bbdbf]/10 rounded-full flex items-center justify-center mx-auto text-[#3bbdbf] text-4xl mb-4">
                                                <FaCheck />
                                            </div>
                                            ...
                                            <button
                                                ...
                                                className="bg-[#3bbdbf] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#2b7a8c] shadow-lg shadow-[#3bbdbf]/20 transition-all"
                                            >
                                                Go to Profile
                                            </button>
                                        </div>
                                    ...
                                    {isAnalyzing && (
                                        <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex flex-col items-center justify-center z-10">
                                            <div className="w-16 h-16 border-4 border-[#3bbdbf]/30 border-t-[#3bbdbf] rounded-full animate-spin mb-4"></div>
                                            <p className="text-[#3bbdbf] font-bold animate-pulse">
