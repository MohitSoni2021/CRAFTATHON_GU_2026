                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`flex items-center space-x-3 px-6 py-3 rounded-full font-bold transition-all whitespace-nowrap ${selectedType === type.id
                                    ? 'bg-white shadow-md ring-2 ring-offset-2 ring-[#3bbdbf]/20 text-gray-900'
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-20 bg-gray-50 rounded-2xl">
                            ...
                            <Link href="/measurements/new" className="text-[#3bbdbf] font-bold hover:underline">Add your first reading</Link>
                        </div>
                    ) : (
                        <div className="space-y-4 max-h-[500px] overflow-y-auto pr-2">
                            {measurements.map((measurement) => (
                                <div key={measurement._id} className="group flex items-center justify-between p-5 rounded-xl border border-gray-100 hover:border-[#3bbdbf]/30 hover:shadow-sm transition-all duration-300">
