        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 sm:px-8 lg:px-16">
          <div className="w-full max-w-md mt-10 lg:mt-0">
            ...
            <p className="text-center text-gray-600 text-sm mt-8">
              ...
              <Link href="/login" className="text-[#2b7a8c] hover:text-[#3bbdbf] font-semibold transition">
                Login
              </Link>
            </p>
            ...
            <div className="text-center text-gray-500 text-xs mt-12">
              <p>Questions? <a href="mailto:support@lifedoc.com" className="text-[#2b7a8c] hover:text-[#3bbdbf] transition">support@lifedoc.com</a></p>
            </div>
          </div>
        </div>
